...
class ZKGrowlWidget extends ZWidget
{
    ...
    public static $grapes = [
        'enable' => true,
        'icon' => '',
        'image' => '/render/notifier/ZKGrowlWidget/image/icon.png',
        'name' => Azl . 'KGrow',
        'title' => Azl . '<b>safasfsa</b><img src="/render/notifier/ZKGrowlWidget/image/icon.png"/>',
