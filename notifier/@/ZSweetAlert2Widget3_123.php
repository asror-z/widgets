...
class ZSweetAlert2Widget3_123 extends ZWidget
{
    ...
    public $_config = [
        ...
        'funcName' => 'mixinQueue',
        'type' => ZSweetAlert2Widget::type['mixin2'],
        ...
        'text' => '',
        'url' => '',
        'icon' => ZSweetAlert2Widget::icon['success'],
        'confirmButtonColor' => '',
        'cancelButtonColor' => '',
        'focusConfirm' => false,
        ...
        'reverseButtons' => true,
                ...
                /*Options*/
        'inputTypes' =>ZSweetAlert2Widget::inputType['text'],
        'width_opt' => 600,
        'padding_opt' => '3em',
        'position' => ZSweetAlert2Widget::position['center'],
        'grow' => ZSweetAlert2Widget::grow['false'],

        'toast' => true ,
        'alertType' =>' Swal.mixin' ,
...
public const icon = [
    ...
    public function codes()
    {
        ...
        $this->options = [
            ...
            'width' => $this->_config['width_opt'],
            'padding' => $this->_config['padding_opt'],
        ...
        $this->options['progressSteps'] = ($this->_config['type'] === self::type['mixin']) ? $this->stepTitle : [];
        $this->options['confirmButtonText'] = ($this->_config['type'] === self::type['mixin']) ? "Next &rarr;" : $this->_config['confirmButtonText'];
                ...
                break;
                    ...
                    case self::type['mixin2']:
                        $this->js .= strtr($this->_layout['mixinGrowl'], [
                ...
                case self::type['mixin']:
                    $this->js .= strtr($this->_layout['mixinQueue'], [
                        '{funcName}' => $this->_config['funcName'],
        ...
        $this->js = strtr($this->js, [
            ...
            '{alertType}' => $this->jscode($this->_config['alertType']),
            ...
            '{padding_opt}' => $this->jscode($this->_config['padding_opt']),
            '{width}' => $this->jscode($this->_config['width']),
            '{width_opt}' => $this->jscode($this->_config['width_opt']),
            '{step}' => Json::encode($this->_aStep, JSON_PRETTY_PRINT),
