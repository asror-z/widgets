 ...
 *
 */
class ZModalWidgetShahzod extends ZWidget
{
    ...
    {
        $this->fileJs('https://cdnjs.cloudflare.com/ajax/libs/jqModal/1.4.2/jqModal.min.js');
...
<div class="bg-light w-25" id="dialog" style="display: none">
        <div class="d-flex w-100 justify-content-between">
                 <div class="modal-header headerStyle">
                                ...
                                <button id="{closeId}" type="button" class="jqmClose btn btn-sm btn-primary p-0 m-0">&times;</button>
                                 {content}
                        </div>
                        <!-- dialog buttons -->
