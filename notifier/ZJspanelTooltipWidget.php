...
class ZJspanelTooltipWidget extends ZWidget
{
    public $config = [];
    public $_config = [
        'content' =>  '<p>tooltip relative to some other element</p>',
        'headt' => 'This Title',
    ];
    ...
    public $_layout = [
        'main' => <<<HTML
                ...
                <input class="btn btn-primary tooltip" type="button" value="ToolTip">
    ...
    */
     ...
     jsPanel.tooltip.create({
        ...
        position: {
            my: 'center-bottom',
            at: 'center-top',
            of: '.tooltip'  // would be the target by default
        },
        contentSize: 'auto',
        border: 'none',
        borderRadius: 6,
