...
class ZSmartTabWidgetMusor extends ZWidget
{
    public $config = [];
    public $_config = [

        'theme' => ZSmartTabWidgetMusor::theme['Classic'],
        'animation' => ZSmartTabWidgetMusor:: animation['none'],
        'orientation' => ZSmartTabWidgetMusor::orientation['horizontal'],
        'justified' => ZSmartTabWidgetMusor::justified['true'],
        'isKeyNavigation' => false,
        'isStopOnFocus' => true,
        'isEnabledAutonavigation' => ZSmartTabWidgetMusor::isEnabledAutonavigation['false'],
        'easing' => ZSmartTabWidgetMusor::easingEmpty['empty'],
        'isEnableURLhash' => ZSmartTabWidgetMusor::isEnableURLhash['true'],
        'isBackButtonSupport' => ZSmartTabWidgetMusor::isBackButtonSupport['true'],
        'isAutoAdjustHeight' => ZSmartTabWidgetMusor::isAutoAdjustHeight['false'],
        'selectedTab' => ZSmartTabWidgetMusor::selectedTab['first'],
        'navigateInterval' => ZSmartTabWidgetMusor::navigateInterval['3500'],
        'animationSpeed' => ZSmartTabWidgetMusor::animationSpeed['400'],
        'ajaxUrl' => ZSmartTabWidgetMusor::ajaxUrl['url'],
        'method' => ZSmartTabWidgetMusor::method['GET'],
        'isAjax' => false,
    ...
    /*
     * QANAQB 6 TA CONST GA BITTA NARSA QOYGANSAN
     *
     * */
...
<!-- SmartTab html -->
<div id="smarttab" class="st st-justified st-theme- st-theme-default st-vertical bg-white rounded-lg">
          
    <ul class="nav font-weight-bold d-flex" id="tab-panel-id" role="tablist">
        {nav_li}
    </ul>

    <div class="tab-content p-0 bg-white" id="tab-content">
        {tab_content_div}
    </div>       
...
HTML,
        ...
        'navLi' => <<<HTML
  <li class=" {tab-margin}">
      <a class="{tab-padding} nav-link border d-flex justify-content-center align-items-center text-light px-5" href="#tab-{id}">
       <span> <strong class="{tab-text-size}"> {tab_description} </strong> </span> 
      </a>
  </li>
HTML,

        'tabContentDiv' => <<<HTML
<div id="tab-{id}" class="tab-pane p-0" role="tabpanel" style="display: none;">
      {content}
</div>
...
CSS,
    ...
    var navLink = $('#smarttab').find('.nav-link');

    navLink.on('click', {change})
    });
    ...
    public function codes()
    {
        ...
        foreach ($items as $item) {
            $navLi_code .= strtr($this->_layout['navLi'], [
                ...
                '{id}' => $i,
                '{tab-padding}' => $this->_config['tab-padding'],
                '{tab-margin}' => $this->_config['tab-margin'],
                '{tab-text-size}' => $this->_config['tab-text-size']
            ]);
