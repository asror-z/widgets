...
class ZButtonWidgetS extends ZWidget
{
    ...
    public $_config = [
        ...
        'title' => '',
        'btn' => true,
        'btnType' => ZButtonWidgetS::btnType['link'],
        'btnStyle' => ZButtonWidgetS::btnStyle['btn-transparent'],
        'btnSize' => ZButtonWidgetS::btnSize['btn-mini'],
        'btnRounded' => true,
        'btnFloating' => false,

        'toggle' => ZButtonWidgetS::toggle['tooltip'],
         ...
         */
        'url' => '#',
        'target' => ZButtonWidgetS::target['_self'],
        'method' => ZButtonWidgetS::method['none'],
        'iconsSm' => false,
         ...
         */
        'badge' => '100',
        'badgeType' => ZButtonWidgetS::badgeType['badge-default'],
         ...
         */
        'hintRounded' => true,
        'ttSize' => ZButtonWidgetS::ttSize['medium'],
        'ttSide' => ZButtonWidgetS::ttSide['top'],
        'ttColor' => ZButtonWidgetS::ttColor['info'],
        'ttAnimate' => ZButtonWidgetS::ttAnimate['bounce'],
        /**
         *
         * Icon
         */

        'iconSize' => ZButtonWidgetS::iconSize['default'],
        'iconColor' => '',
    ...
    public $event = [];
    public $_event = [
        'click' => ' console.log("ZButtonWidgetS | $eventClick") ',
        'dblclick' => ' console.log("ZButtonWidgetS | $eventDblclick") ',
        'mouseenter' => ' console.log("ZButtonWidgetS | $eventMouseEnter") ',
        'mouseleave' => ' console.log("ZButtonWidgetS | $eventMouseLeave") ',
        'keyup' => ' console.log("ZButtonWidgetS | $eventKeyup") ',
    ];
...
HTML,
        ...
        'style' => <<<CSS
            ...
            .btn-micro + .dropdown-toggle-split, .btn-group-micro > .btn + .dropdown-toggle-split {
...
JS,
    ...
    if ($this->_config['btnSize']==='btn-micro'){
...
JS;
        ...
        if ($this->_config['btnType'] === ZButtonWidgetS::btnType['link'])
