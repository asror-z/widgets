...
class ZButtonWidgetX extends ZWidget
{
    ...
    public $_config = [
        ...
        'btnStyle' => ZButtonWidgetX::btnStyle['btn-transparent'],

        'btnRounded' => true,
        'btnFloating' => false,

        'toggle' => ZButtonWidgetX::toggle['tooltip'],
         ...
         */
        'url' => '',
        'target' => ZButtonWidgetX::target['_self'],
        'method' => ZButtonWidgetX::method['none'],
        'iconsSm' => false,
         ...
         */
        'badge' => '100',
        'badgeType' => ZButtonWidgetX::badgeType['badge-default'],
         ...
         */
        'hintRounded' => true,
        'ttSize' => ZButtonWidgetX::ttSize['medium'],
        'ttSide' => ZButtonWidgetX::ttSide['top'],
        'ttColor' => ZButtonWidgetX::ttColor['info'],
        'ttAnimate' => ZButtonWidgetX::ttAnimate['bounce'],
        /**
         *
         * Icon
         */

        'iconSize' => ZButtonWidgetX::iconSize['default'],
    ...
    public $event = [];
    public $_event = [
        'click' => ' console.log("ZButtonWidgetX | $eventClick") ',
        'dblclick' => ' console.log("ZButtonWidgetX | $eventDblclick") ',
        'mouseenter' => ' console.log("ZButtonWidgetX | $eventMouseEnter") ',
        'mouseleave' => ' console.log("ZButtonWidgetX | $eventMouseLeave") ',
        'keyup' => ' console.log("ZButtonWidgetX | $eventKeyup") ',
    ];
...
JS;
        ...
        /*if ($this->_config['btnSize'] === ZButtonWidgetX::btnSize['default'])
            $_layout = $this->_layout['link'];*/
        

        if ($this->_config['btnType'] === ZButtonWidgetX::btnType['link'])
            $_layout = $this->_layout['link'];
        else
        ...
        /*$sweetBtn = ZSettingBtnWidget::widget([

        ]);*/

        if ($this->_config['btnType'] === ZButtonWidgetX::btnType['sweetBtn']) {
            /*echo $sweetBtn;*/
           /* $_layout = $this->_layout['sweetBtn'];*/
        }
