...
class ZFloatTheadWidget extends ZWidget
{
    public $config = [];
    public $_config = [
...
JS,
    ...
    public function asset()
    {
        ...
        $this->fileCss('/render/navigat/ZStickyElementsWidget/demo/Sticky Elements_files/css.css');
        $this->fileJs('https://cdn.jsdelivr.net/npm/stickyelements@2.2.1/dist/stickyelements-animate.js');
        // $this->fileJs('/render/navigat/ZStickyElementsWidget/demo/Sticky Elements_files/sticky.js');
    }
