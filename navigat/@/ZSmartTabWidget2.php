...
class ZSmartTabWidget2 extends ZWidget
{
    public $config = [];
    public $_config = [

        'theme' => ZSmartTabWidget2::theme['Classic'],
        'animation' => ZSmartTabWidget2:: animation['none'],
        'orientation' => ZSmartTabWidget2::orientation['horizontal'],
        'justified' => ZSmartTabWidget2::justified['true'],
        'isKeyNavigation' => false,
        'isStopOnFocus' => true,
        'isEnabledAutonavigation' => ZSmartTabWidget2::isEnabledAutonavigation['false'],
        'easing' => ZSmartTabWidget2::easingEmpty['empty'],
        'isEnableURLhash' => ZSmartTabWidget2::isEnableURLhash['true'],
        'isBackButtonSupport' => ZSmartTabWidget2::isBackButtonSupport['true'],
        'isAutoAdjustHeight' => ZSmartTabWidget2::isAutoAdjustHeight['false'],
        'selectedTab' => ZSmartTabWidget2::selectedTab['first'],
        'navigateInterval' => ZSmartTabWidget2::navigateInterval['3500'],
        'animationSpeed' => ZSmartTabWidget2::animationSpeed['400'],
        'ajaxUrl' => ZSmartTabWidget2::ajaxUrl['url'],
        'method' => ZSmartTabWidget2::method['GET'],
        'isAjax' => ZSmartTabWidget2::isAjax['false'],
...
HTML,
  ...
  <li class="{tab-padding} {tab-margin}">
      <a class="nav-link border d-flex justify-content-center align-items-center py-3 px-2"  href="#tab-{id}">
       <span> <strong class="font-weight-bold {tab-text-size}"> {tab_description} </strong> </span> 
      </a>
  </li>
HTML,
