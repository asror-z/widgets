...
class ZSmartTabWidget extends ZWidget
{
    public $config = [];
    public $_config = [
        'mcontent' => 'p-0',
    ...
    public $_event = [
        ...
        'is_vertical_click' => ' $("#is_vertical").on("click", function() {
            ...
            $("#{id}").smartTab("setOptions", options);
            return true;
        });',
...
HTML,
        ...
        'tabContentDiv' => <<<HTML
<div id="tab-{id}" class="tab-pane {mcontent}" role="tabpanel" style="display: none;">
      {content}
</div>
    ...
    public function codes()
    {
        ...
        foreach ($items as $item) {
            ...
            $tabContentDiv_code .= strtr($this->_layout['tabContentDiv'], [
                ...
                '{id}' => $i,
                '{mcontent}' => $this->_config['mcontent']
            ]);
            $i++;
        }
