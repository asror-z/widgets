...
class ZMultistepformwizardWidget extends ZWidget
{
    public $config = [];
    public $_config = [
        'steps' => []
                ...
                <div class="row">
                    <div class="col-md-12 mx-0">
                        <form id="msform">
                            ...
                            <ul id="progressbar">
HTML;
                            foreach ($this->_config['steps'] as $key => $item):
                                    $active = '';
                                    if ($key == 0)
                                        $active = 'active';
                                  $this->htm .= <<<HTML
                                    <li class="{$active}" id="{$item['itemID']}"><strong>{$item['value']}</strong></li>
                                HTML;
...
HTML;
        ...
        #progressbar #account:before {
            content: url("/render/images/assets/image/lock-icon.png");
        }
