...
class ZAuroralWidget extends ZWidget
{
...
CSS
    ...
    {
        $this->fileCss('/publish/Animos/Background/CSS/Lunarlogic Auroral/auroral-master/auroral-master/css/auroral.css');
        /*$this->fileCss('https://cdn.jsdelivr.net/npm/bootstrap@4.4.1/dist/css/bootstrap.min.css');*/
        $this->fileCss('/publish/Animos/Background/CSS/Lunarlogic Auroral/auroral-master/auroral-master/min/auroral.min.css');
       $this->fileJs
