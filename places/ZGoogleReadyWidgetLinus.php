...
class ZGoogleReadyWidgetLinus extends ZWidget
{
    #region Congif
    /**
     * Configuration
    ...
    public $_layout = [
        'main' => <<<HTML
         <div class="row">
            {saveForm}
             <div id="{id}-locations"></div>                   
             <div class="col-md-12">
                  <div class="col-lg-7 col-md-7 col-sm-7" id="{id}-search_area" style="position: relative;" >      
...
CSS,
        'js' => <<<JS
            ...
            $('#{id}').ready(
                ...
                console.log("Map is getting ready")
                console.log("{name}");
               ...
               /*For save searched place_id*/
                ...
                //#region Getting CurrentPosition
                ...
                searchBoxPlace.addListener('places_changed', function () {
                    ...
                    if (searchAutoComplete) {
                        document.getElementById('search_map_{id}').value =  document.getElementById('w3').value;
                    }
                     
                })
                //#endregion
             
                //#region Prevent to press ENTER button in search area        
                ...
                //#region Sending request via AJAX to get image of countries    
            ...
            //#endregion
                ...
                //#region For save or edit markers
...
JS,
    ...
    public function codes()
    {
        ...
        if($this->_config['searchPlaceImageShow'])
        {
            ...
            $image='
            <img class="manage one place_image" id='.$image_id.' style="width: 200px; height: 200px; position: absolute; margin-left:85%; top: 15%; z-index: 1" src="https://maps.googleapis.com/maps/api/place/photo?key=AIzaSyBkxS5l87lclaC6MIWSGejdCXL13wSShRo&maxwidth=580
