...
class ZGoogleDb17Widget extends ZWidget
{
    #region Congif
    /**
     * Configuration
        ...
        'main' => <<<HTML
         <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <button type="button id="iconl"></button>               
                </div>
                {img}
            </div>                    
...
//#region search in map
    ...
    {
        /*********************************************************************************/
        var input = document.getElementById('search_map{id}');
...
JS,
    ...
    public function codes()
    {
        ...
        {
            $search='
                <input id="search_map" type="tel" style="position: absolute; z-index: 111111; margin-top:11px; width: 35%; margin-left: 205px;" class="form-control" placeholder="Search ..." />
            ' ;
        }
        if($this->_config['iconLocation'])
        {
            $iconLocation='
                <i class="fas fa-location fa-2x " id="iconl"></i>
            ' ;
        }
        if($this->_config['iconImageShow'])
        {
            $iconImageShow='
...
&photoreference=CnRtAAAATLZNl354RwP_9UKbQ_5Psy40texXePv4oAlgP4qNEkdIrkyse7rPXYGd9D_Uj1rVsQdWT4oRz4QrYAJNpFX7rzqqMlZw2h2E2y5IKMUZ7ouD_SlcHxYq1yL4KbKUv3qtWgTK0A6QbGh87GB3sscrHRIQiG2RrmU_jF4tENr9wGS_YxoUSSDrYjWmrNfeEHSGSc3FyhNLlBU" />
        ...
        $this->js = strtr($this->_layout['js'], [
            ...
            '{iconLocation}'      => ($this->_config['iconLocation'])? 'true': 'false',
            '{iconImageShow}'      => ($this->_config['iconImageShow'])? 'true': 'false',
