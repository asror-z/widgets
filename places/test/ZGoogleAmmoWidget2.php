...
class ZGoogleAmmoWidget2 extends ZWidget
{
    #region Congif
    /**
     * Configuration
...
JS,
    ...
    {
        $this->fileJs('https://maps.googleapis.com/maps/api/js?key=AIzaSyBkxS5l87lclaC6MIWSGejdCXL13wSShRo&callback=createMap',3);
        /*$this->fileJs('\render\places\ZGoogleWidget\asset\js\main.js',3);*/
        $this->fileJs('https://cdnjs.cloudflare.com/ajax/libs/bootbox.js/5.4.0/bootbox.min.js',3);
        $this->fileJs('https://unpkg.com/@google/markerclustererplus@4.0.1/dist/markerclustererplus.min.js',3);
    ...
    public function codes()
    {
       ...
       /* $typeAHead = \zetsoft\widgets\inputes\ZKTypeaheadWidget::widget([
        ...
        {
            $search='
                <input id="search_map_'.$this->id.'" type="tel" class="form-control" placeholder="Search ..."/>
            ' ;
        }
