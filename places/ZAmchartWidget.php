...
JS
    ...
    public function asset()
    {
        ...
        $this->fileJs('/render/places/assets/Maps/Amcharts/maps.js');
        $this->fileJs('/render/places/assets/Maps/Amcharts/worldLow.js');
...
JS,
        ...
        foreach ($this->_config['value'] as $key => $value) {
            ...
            if ($this->_config['colorRandom']) {
                ...
                $color = ZArrayHelper::getValue(self::color, $colorKey);
            } else {
