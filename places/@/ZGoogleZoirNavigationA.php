...
class ZGoogleZoirNavigationA extends ZWidget
{
    #region Congif
    /**
     * Configuration
...
$('#{id}-Openbtn').on('click', function() {     
    ...
    if(openCheck != 1){
        ...
        document.getElementById("{id}-Openbtn").style.top = "102px";
                         /*   document.querySelector(".map-change").style.left = "28vw";
                         ...
                         /*   document.querySelector(".footer-change").style.left = "28vw";
                            ...
                            document.getElementById("{id}-Sidebar").style.left = "-500px";
                      /*      document.querySelector(".map-change").style.left = "0vw";
                ...
                function gettingCoordinates() {
                    const  coordinates = {generateAlreadySaved};
                       var index = 0;
                    for(var i = 0; i < coordinates.length; i++){
                        ...
                        addressCoordinates += latCoor +','+ longCoor+'/';
                  ...
                  console.log(addressCoordinates);
                      ...
                      window.open("https://www.google.com/maps/dir/Katta+Darkhon+St,+Tashkent/''/24.1009696,46.115959/35.2856696,54.6598321/24.1009696,46.115959/41.3067804,69.2077548/41.2621451,69.2967015/40.7950937,68.7915616/41.3268107,69.2348099/40.7950937,68.7915616/41.326594,69.2346934/41.3401202,69.3034179/@37.5106265,49.0835728,4.11z/data=!4m23!4m22!1m5!1m1!1s0x38aef4c06e227df3:0xa368fb55392fe24d!2m2!1d69.3092476!2d41.3312004&destination_place_id=ChIJVURF9JyLrjgR43B9LalX-vE8&travelmode=Driving", "_blank", "toolbar=yes,scrollbars=yes,resizable=yes,top=500,left=500,width=400,height=400");                   
                  });
                //#regionEnd
