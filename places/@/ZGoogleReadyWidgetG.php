...
class ZGoogleReadyWidgetG extends ZWidget
{
    #region Congif
    /**
     * Configuration
  ...
  */
    ...
    public function codes()
    {
        ...
        if($this->_config['searchPlaceImageShow'])
        {
            ...
            $image='
            <img class="manage one place_image" id='.$image_id.' style="width: 200px; height: 200px; position: absolute;  top: 15%; z-index: 2" src="https://maps.googleapis.com/maps/api/place/photo?key=AIzaSyBkxS5l87lclaC6MIWSGejdCXL13wSShRo&maxwidth=580
