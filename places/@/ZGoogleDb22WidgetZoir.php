...
class ZGoogleDb22WidgetZoir extends ZWidget
{
    #region Congif
    /**
     * Configuration
       ...
       <div class="row">
        ...
        -->
                     ...
                     <div class="distance-map Small shadow p-3">
                         <p class="pl-4">Total MatrixGoogle: <span id="total"></span></p>
                             </div>
                  </div> 
                </div> 
                
                <div id="Openbtn" class="openbtn"><i class="fas fa-chevron-right"></i></div>              <button id="my-location" class="btn btn-light" type="button" style="position: absolute; top: 6px; right: 65px ; z-index:1; background-color: white!important;  padding: 10px;" > <i class="fas fa-location-arrow fa-lg"  style="color: limegreen;"></i></button>                       
