...
class ZGoogleZoirReadyNavigation extends ZWidget
{
    #region Congif
    /**
     * Configuration
    ...
    if(openCheck != 1){
        ...
        document.getElementById("{id}-Openbtn").style.top = "102px";
                ...
                function gettingCoordinates() {
                    ...
                    var url = "https://www.google.com/maps/dir/Katta+Darkhon+St,+Tashkent/"+addCoords+"&destination&travelmode=Driving";
...
JS,
    ...
    //    vd($arr);
      ...
      /*  $waresCoordinates = array();
        ...
        vd($savedWaresAdresses = ArrayHelper::getColumn($waresAdresses, 'location.0'));  */
