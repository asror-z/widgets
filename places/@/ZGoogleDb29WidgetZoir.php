 ...
 *
 * Class ZGoogleWidget
 * @licience : Davlatmurod Jumaboyev, Zoirjon Sobirov, Odilov Shukurullo
 */
...
class ZGoogleDb29WidgetZoir extends ZWidget
{
    #region Congif
    /**
     * Configuration
...
-->                
                ...
                <button id="my-location" class="btn btn-light" type="button" style="position: absolute; top: 165px; right: 65px ; z-index:1; background-color: white!important;  padding: 10px;" > <i class="fas fa-location-arrow fa-lg"  style="color: limegreen;"></i></button>
