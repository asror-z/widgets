...
class ZGoogleDb27WidgetLobar extends ZWidget
{
    #region Congif
    /**
     * Configuration
...
function createWriteMap()
{
    ...
    map.addListener('click', function(event) {
        ...
        {
            var marker = addMarker(event.latLng.lat(), event.latLng.lng());
...
function addMarker(markerLat, markerLng) {
    ...
    google.maps.event.addListener(marker, 'dragend', function() {
        ...
        var contentString = '<b style="text-align:center">'+'</b><br>'+markerLng;
