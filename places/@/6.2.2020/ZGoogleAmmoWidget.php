...
class ZGoogleAmmoWidget extends ZWidget
{
    #region Congif
    /**
     * Configuration
...
JS,
    ...
    {
        $this->fileJs('https://maps.googleapis.com/maps/api/js?key=AIzaSyBkxS5l87lclaC6MIWSGejdCXL13wSShRo&callback=createMap');
