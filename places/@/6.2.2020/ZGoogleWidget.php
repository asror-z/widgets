...
use zetsoft\widgets\places\ZGoogleSideBarWidget;
 ...
 * Created By: Daho
 */
class ZGoogleWidgsadasdet extends ZWidget
{
    ...
    public function codes()
    {
        $this->layout = [
            'main' => <<<HTML
        <button id="btn-location"{readonly}>Go to my Location</button>
    <input id="pac-input" class
    <div id="map" >
 
</div>
    <div id="floating-panel">="controls" type="text" placeholder="Search Box">
