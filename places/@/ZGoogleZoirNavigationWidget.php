...
class ZGoogleZoirNavigationWidget extends ZWidget
{
    #region Congif
    /**
     * Configuration
...
&photoreference=CnRtAAAATLZNl354RwP_9UKbQ_5Psy40texXePv4oAlgP4qNEkdIrkyse7rPXYGd9D_Uj1rVsQdWT4oRz4QrYAJNpFX7rzqqMlZw2h2E2y5IKMUZ7ouD_SlcHxYq1yL4KbKUv3qtWgTK0A6QbGh87GB3sscrHRIQiG2RrmU_jF4tENr9wGS_YxoUSSDrYjWmrNfeEHSGSc3FyhNLlBU" />
        ...
        /* @var Ware $order */
        /* @var Order $order */
        foreach ($this->_config['orderAddress'] as $key=> $order ){
              vd($order);
        }
        ...
        $placeAdres  = PlaceAdress::find()
            ...
            ->all();
        vd($savedAdresses= ArrayHelper::getColumn($placeAdresses,'location.0', ));
        vd($saveAdresses= ArrayHelper::getColumn($placeAdres,'location.0', ));
