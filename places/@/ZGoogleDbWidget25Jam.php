...
class ZGoogleDbWidget25Jam extends ZWidget
{
    #region Congif
    /**
     * Configuration
...
CSS,
  ...
  input.innerHTML = `<i class="fas fa-dot-circle circle-c"></i>
                     <input class="form-control ml-2" type="text" placeholder="Куда">`
   ...
   input.remove() ;
                ...
                document.getElementById("Openbtn").onclick = function openBtn(){
	                if(openCheck==0){
                            ...
                            document.getElementById("Openbtn").style.marginLeft = "380px";
                            ...
                            document.getElementById("Openbtn").style.marginLeft= "-20px";
...
JS,
    ...
    public function codes()
    {
        ...
        $searchHome='
            ...
            ';
            $addressA = '<input class="form-control" id="search_map_a_'.$this->get().'"  type="text" placeholder="Укажите пункт отправления или выберите его на карте..."> <br>';
        $addressB = '<input class="form-control" id="search_map_b_'.$this->get().'"  type="text" placeholder="Укажите пункт отправления или выберите его на карте..."> <br>';
