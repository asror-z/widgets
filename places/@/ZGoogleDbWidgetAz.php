...
class ZGoogleDbWidgetAz extends ZWidget
{
    #region Congif
    /**
     * Configuration
    ...
    public $_layout = [
        'main' => <<<HTML
         <div class="row">
            {saveForm}
            <div id="{id}-locations" class="hinput">
             <input type="text" id="hInput" name="{name}"/>
            </div>             
            <div class="col-md-12">
...
CSS,
        'js' => <<<JS
    var bootboxValue = $('.bootbox-input').val()
    $('#hInput').val(bootboxValue)
    console.log(bootboxValue)
var map;
var cnt_ind;
