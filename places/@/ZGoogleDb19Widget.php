...
class ZGoogleDb19Widget extends ZWidget
{
    #region Congif
    /**
     * Configuration
...
JS,
    ...
    public function asset()
    {
        ...
        $this->fileCss('\render\places\ZGoogleWidget\asset\main\css\styleKH.css');
    }
    ...
    public function codes()
    {
        ...
        {
            $search='
                <input id="search_map_'.$this->getId().'" style="position: absolute; z-index: 2; margin-top:11px; width: 35%; margin-left: 205px;" type="tel" class="form-control" placeholder="Search ..."/>
            ' ;
        }
        ...
        if($this->_config['searchPlaceImageShow'])
        {
            ...
            $image='
            <img class="manage one place_image" id='.$image_id.'  src="https://maps.googleapis.com/maps/api/place/photo?key=AIzaSyBkxS5l87lclaC6MIWSGejdCXL13wSShRo&maxwidth=580
