...
class ZGoogleReadyWidgetZoir extends ZWidget
{
    #region Congif
    /**
     * Configuration
         ...
         <div class="row">
                ...
                <div class="col-md-12">
                    <div class="col-lg-7 col-md-7 col-sm-7" id="{id}-search_area" style="position: relative;" >      
                     ...
                     <button id="my-location" class="btn btn-light" type="button" style="position: absolute; top: 6px; right: 65px ; z-index:1; background-color: white!important;  padding: 10px;" > <i class="fas fa-location-arrow fa-lg"  style="color: limegreen;"></i></button>   
...
HTML,
      ...
      .pac-container {
        z-index: 99999;
        position: relative!important ;top:-76%!important ; display: block;
    }
...
/*API key*/
    ...
    //#endregion
$('#placeadresszoir-place_div').ready(function (){
    console.log('changed');
      $('.pac-container .pac-logo').css({"top":"-95%!important", "position":"relative!important"});
