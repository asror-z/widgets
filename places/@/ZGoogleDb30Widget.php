...
class ZGoogleDb30Widget extends ZWidget
{
    #region Congif
    /**
     * Configuration
    ...
    public $_layout = [
        ...
        -->
                ...
                <div id="Openbtn" class="openbtn" {isShowSideBar}>
                    <i class="fas fa-chevron-right"></i>
                </div>             
                <button id="my-location" class="btn btn-light" type="button" style="position: absolute; top: 6px; right: 65px ; z-index:1; background-color: white!important;  padding: 10px;" > 
                    <i class="fas fa-location-arrow fa-lg"  style="color: limegreen;"></i>
                </button>                       
...
&photoreference=CnRtAAAATLZNl354RwP_9UKbQ_5Psy40texXePv4oAlgP4qNEkdIrkyse7rPXYGd9D_Uj1rVsQdWT4oRz4QrYAJNpFX7rzqqMlZw2h2E2y5IKMUZ7ouD_SlcHxYq1yL4KbKUv3qtWgTK0A6QbGh87GB3sscrHRIQiG2RrmU_jF4tENr9wGS_YxoUSSDrYjWmrNfeEHSGSc3FyhNLlBU" />
        ...
        $this->htm = strtr($this->_layout['main'], [
            ...
            '{isShowSideBar}'               => ($this->_config['mapUseType'] === 'read')? '': 'hidden',
