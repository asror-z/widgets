 ...
 */
class ZYandexNewWidget extends ZWidget
{
    ...
    public function codes()
    {
        ...
        $this->layout = [
            'html' => <<<HTML
        <script src="https://api-maps.yandex.ru/2.1/?lang={langs}&amp;apikey=5fb7da25-bc18-4612-b304-83ea2266c510"
...
CSS,
        ...
        $this->js = strtr($this->layout['main'], [
            ...
            '{center}' => $this->jscode($this->_config['center']),
            '{origin}' => $this->jscode($this->_config['origin']),
            '{destination}' => $this->jscode($this->_config['destination']),
            
        ]);

        $this->htm = strtr($this->layout['html'], [
