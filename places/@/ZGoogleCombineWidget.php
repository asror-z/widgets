...
class ZGoogleCombineWidget extends ZWidget
{
    #region Congif
    /**
     * Configuration
    ...
    public $_config = [
        ...
        'limitWayPoints'            => 5,          // number min == 2, max == n(but there's a limit for google api request https://developers.google.com/maps/documentation/directions/usage-and-billing)
        'mapUseType'                => 'write',   //string == write || read
        'optimizeWaypoints'         => false,    //boolean == true || false
    ];
         ...
         <div class="row">
                ...
                <div class="col-md-12">
                    <div class="col-lg-7 col-md-7 col-sm-7" id="{id}-search_area">      
                      ...
                      {img} 
                      <button class="btn btn-light" type="button" style="position: absolute; top: 6px; right: 110px ; z-index:1; background-color: white; padding: 10px;" > <i class="fas fa-location-arrow fa-lg" id="my-location" style=""></i></button>   
                    <button class="btn btn-light"  type="button" style="position: absolute; top: 6px; right: 65px ; z-index:1; background-color: white; padding: 10px;"><i class="fas fa-image fa-lg" id="image_btn"></i></button> 
...
JS,
    ...
    public function codes()
    {
        ...
        if($this->_config['searchPlaceImageShow'])
        {
            ...
            $image='
            <img class="manage one place_image" id='.$image_id.' style="width: 200px; height: 200px; position: absolute; display:none; top: 15%; z-index: 1; left:80%;" src="https://maps.googleapis.com/maps/api/place/photo?key=AIzaSyBkxS5l87lclaC6MIWSGejdCXL13wSShRo&maxwidth=580
