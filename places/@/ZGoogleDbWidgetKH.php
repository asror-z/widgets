...
class ZGoogleDbWidgetKH extends ZWidget
{
    #region Congif
    /**
     * Configuration
    ...
    function getPlaceImage(place_id){
        if (searchPlaceImageShow){
            ...
            var imageNotFound = 'https://www.salonlfc.com/wp-content/uploads/2018/01/image-not-found-scaled-1150x647.png';
             //Ajax request
             $.ajax({url: "\service.aspx?namespace=inputs&service=depDrops&method=map&args=" + place_id, 
...
JS,
  ...
  */
    ...
    public function codes()
    {
        ...
        {
            $search='
                <input id="search_map_'.$this->getId().'" style="position: absolute; z-index: 1; top:11px;  left: 55%; width:70%;" type="tel" class="form-control" placeholder="Search ..."/>
            ' ;
        }
        ...
        {
            $image='
            <img class="manage one" id="place_image" style="width: 200px; height: 200px; position: absolute; right: 5%;  top: 150px; z-index: 1" src="https://maps.googleapis.com/maps/api/place/photo?key=AIzaSyBkxS5l87lclaC6MIWSGejdCXL13wSShRo&maxwidth=580
