...
class ZGoogleWidgetDilmurod extends ZWidget
{
    #region Congif
    /**
     * Configuration
...
JS,
  ...
  */
    ...
    {
        $url = 'https://maps.googleapis.com/maps/api/js?key=AIzaSyBkxS5l87lclaC6MIWSGejdCXL13wSShRo&callback=createMap'.$this->getId();
