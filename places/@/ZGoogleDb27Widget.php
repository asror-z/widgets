...
class ZGoogleDb27Widget extends ZWidget
{
    #region Congif
    /**
     * Configuration
        ...
        'main' => <<<HTML
                ...
                <div class="col-md-6 sidebar pl-3 Small shadow" id="Sidebar">
                   ...
                   <div class="map-search-in">
                    ...
                    <i class="far fa-circle location"></i>
                    ...
                    <div id="directions" class="map-search-from w-75">
                      <input class="form-control w-100" id="direction_a" type="text" placeholder="Укажите пункт отправления или выберите его на карте..."> <br>
                        <input class="form-control w-100" id="direction_b" type="text" placeholder="Укажите пункт назначения...">
