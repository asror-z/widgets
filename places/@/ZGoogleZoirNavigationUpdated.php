...
class ZGoogleZoirNavigationUpdated extends ZWidget
{
    #region Congif
    /**
     * Configuration
...
function optimalPoints() {
    ...
    /**devicePixelRatio orentation START**/
      var gn;
    function init_gn() {
        var args = {
            logger: logger
    ...
    function logger(data) {
        $('#error-message').append(data.message + 'n');
    }
    ...
    /**devicePixelRatio orentation END**/
    ...
    url: 'https://developers.google.com/maps/documentation/javascript/examples/full/images/beachflag.png',
      ...
      var car  = 'https://cdn.pixabay.com/photo/2017/02/01/12/23/car-2030056_960_720.png';
    var directionMarkerA = new google.maps.Marker({
        map: map,
        icon: {
		url: "https://cdn.pixabay.com/photo/2017/02/01/12/23/car-2030056_960_720.png",
...
JS,
    ...
    public function asset()
    {
        ...
        $this->fileJs('https://rawcdn.githack.com/adtile/Full-Tilt/22a1007af229153e5b897afd1fc903d7d91fe481/dist/fulltilt.min.js');
        $this->fileJs('https://rawcdn.githack.com/dorukeker/gyronorm.js/39d5fda182cd8655e32ae0d1e5f58eade3c8c1d2/dist/gyronorm.js');
