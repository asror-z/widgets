 ...
 *
 */
class ZYandexWidgetKH extends ZWidget
{
    ...
    public $_layout = [
        ...
        <!--<script src="/render/places/ZYandexWidgetOld/assets/combine.js"></script>-->
...
HTML,
        ...
        'js' => <<<JS
         ...
         ymaps.ready(function () {
            ...
            $('.ymaps-2-1-76-float-button-icon_icon_geolocation').on('click',function() {
                console.log(123456) ;
            }) ;
