...
class ZGoogleDb3Widget extends ZWidget
{
    #region Congif
    /**
     * Configuration
...
//#region search in map
    ...
    {
        /*********************************************************************************/
        var input = document.getElementById('{id}-search_map');
        ...
        searchBox.addListener('places_changed', function () {
            ...
            map.fitBounds(bounds);
            document.getElementById('{depend_id}').value = document.getElementById('{id}-search_map').value;
        })
    }
//#endregion
