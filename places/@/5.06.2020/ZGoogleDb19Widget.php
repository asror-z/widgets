        ...
        function changeImage(place, status) {
            if (status === google.maps.places.PlacesServiceStatus.OK) {
                if (place.hasOwnProperty('photos')) {
                    ...
                    document.getElementById("place_image").src = place.photos[0].getUrl();
                }
                else $('#place_image').css('display','none');
            }
        }
    }
}
...
JS,
    ...
    public function codes()
    {
        ...
        {
            $image='
            <img class="manage one" id="place_image" style="width: 200px; height: 200px; position: absolute; left: 70%;  top: 15%; z-index: 1" src="https://maps.googleapis.com/maps/api/place/photo?key=AIzaSyBkxS5l87lclaC6MIWSGejdCXL13wSShRo&maxwidth=580
