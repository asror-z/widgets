...
class ZGoogleDb21Widget extends ZWidget
{
    #region Congif
    /**
     * Configuration
    ...
    public $_config = [
        ...
        'limitWayPoints' => 5           // number min == 2, max == n(but have limit google api https://developers.google.com/maps/documentation/directions/usage-and-billing)
...
function computeTotalDistance(result) {
    ...
    total = total / 1000;
    document.getElementById('total').innerHTML = total + ' km with ' + 'DRIVING';
}
//#endregion
...
&photoreference=CnRtAAAATLZNl354RwP_9UKbQ_5Psy40texXePv4oAlgP4qNEkdIrkyse7rPXYGd9D_Uj1rVsQdWT4oRz4QrYAJNpFX7rzqqMlZw2h2E2y5IKMUZ7ouD_SlcHxYq1yL4KbKUv3qtWgTK0A6QbGh87GB3sscrHRIQiG2RrmU_jF4tENr9wGS_YxoUSSDrYjWmrNfeEHSGSc3FyhNLlBU" />
        ...
        $this->js = strtr($this->_layout['js'], [
            ...
            '{generateAlreadySaved}'    => (length($this->value) > 0)?json_encode($this->value) :json_encode([])
        ]);
