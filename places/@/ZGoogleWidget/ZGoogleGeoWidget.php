...
class ZGoogleGeoWidget extends ZWidget
{
    #region Congif
    /**
     * Configuration
        ...
        'main' => <<<HTML
           <div class="row">
                ...
                <div class="col-lg-7 col-md-7 col-sm-7" id="search_area">
                    {search}
                       <img src="http://getdrawings.com/free-icon/map-pin-icon-png-69.png" style="" id="getmyAddress">  
                </div>  
           ...
           <div id="content_modal" class="modal-dialog modal-dialog-centered" role="document"  >
                    <div class="modal-content">
                     <div class="modal-header">
                        <h3 class="modal-title" id="exampleModalLabel">Adding Location</h3>        </div>
                    <div class="modal-body">
                        <input type="text" id="address_area_input" value="" name="" required ><br>
...
function createMap() {
    ...
    map.addListener('click', function(event) {
          ...
          if (searchPlaceId.length > 0)
        {
            ...
            document.getElementById('text_tct').insertAdjacentHTML(
                "beforeend",
                /*'<p>'+dataFet+'</p>' ,*/
        ...
        .catch(err => console.warn(err.message));
            ...
            }else alert("Manzil kiritishdan oldin. Maziliga qayinroq mo'ljal qilib oling. Qidish ... ")
