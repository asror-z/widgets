...
class ZGoogleDbWidgesadt extends ZWidget
{
    #region Congif
    /**
     * Configuration
...
CSS,
        'js' => <<<JS
var map;
/*For save count hidden input id*/
var cnt_ind;
    ...
    bootbox.prompt({
        ...
        callback: function(result){ 
            ...
            .then(data => {
                ...
                if (type === 'push') {
                    $("<input type='text' name = '{name}[" + index + "][place_id]' value='" + savedData[i].place_id + "'>").appendTo('#locations'); 
...
/*            'model' => new \zetsoft\models\core\CoreInput(),
        ...
        {
            $image='
               <img id="place_image" style="" src="https://maps.googleapis.com/maps/api/place/photo?key=AIzaSyBkxS5l87lclaC6MIWSGejdCXL13wSShRo&maxwidth=580
        &photoreference=CnRtAAAATLZNl354RwP_9UKbQ_5Psy40texXePv4oAlgP4qNEkdIrkyse7rPXYGd9D_Uj1rVsQdWT4oRz4QrYAJNpFX7rzqqMlZw2h2E2y5IKMUZ7ouD_SlcHxYq1yL4KbKUv3qtWgTK0A6QbGh87GB3sscrHRIQiG2RrmU_jF4tENr9wGS_YxoUSSDrYjWmrNfeEHSGSc3FyhNLlBU" />
                             <i class="fas fa-location-arrow fa-3x" id="getmyAddress"></i>
           ' ;
        ...
        $this->js = strtr($this->_layout['js'], [
            ...
            '{matkerCoun*/t}' => $this->_config['matkerCount'],
