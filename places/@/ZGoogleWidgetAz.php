...
class ZGoogleWidgetAz extends ZWidget
{
    #region Congif
    /**
     * Configuration
         ...
         <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="col-lg-7 col-md-7 col-sm-7  " id="{id}-search_area">      
                         ...
                         <button type="button" id="btn1">Image</button> 
                         </div> 
...
*/
    ...
    public function codes()
    {
        ...
        {
            $search='
                <input id="search_map_'.$this->getId().'" style="position: absolute; z-index: 111111; margin-top:40px; width: 35%; margin-left: 205px;" type="tel" class="form-control" placeholder="Search ..."/>
            ' ;
        }
        ...
        {
            $image='
            <img class="manage one" id="place_image" style="width: 200px; height: 200px; position: absolute; top: 15%; z-index: 1" src="https://maps.googleapis.com/maps/api/place/photo?key=AIzaSyBkxS5l87lclaC6MIWSGejdCXL13wSShRo&maxwidth=580
