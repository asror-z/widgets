 ...
 */
class ZElfinderWidget3 extends ZWidget
{
    ...
    public function codes()
    {
        ...
        if (!empty($this->_config['context'])) {
            foreach ($this->_config['context'] as $contextItem) {
                ...
                $contextMenuReplace .= strtr($context,
                    [
        ...
        if($contextMenuReplace == '')
            $contextMenuReplace = $context;
        ...
        $this->js = strtr($this->_layout['js'], [
            ...
            '{toolbar}' => $toolbar,
            '{context}' => $contextMenuReplace,
            '{contextConfig}'=> $this->_layout['contextMenu'],
