...
/**
 *
 * Class ZJqueryKnobWidget
 * https://github.com/aterrien/jQuery-Knob
 *
 * Created By: Xakimjon Ergashov
 * Refactored:
 */
class ZJqueryKnobWidgetReadOnly extends ZWidget
{
    ...
    public $_config = [
        'text' => '',
        'value' => '2',
        'fgcolor' => ZColor::color['red'],
        'fgcolor2' => ZColor::color['blue'],
        'max' => 100,
        'readOnly' => false,
    ...
    public $_layout = [
        ...
        'main' => <<<HTML
                ...
                <div class="text-center">
                    ...
                    <h4 id="current-session-type">{text}</h4>
...
HTML,
        ...
        // i deci}ded to prepend it here instead to prevent showing the
        // input field that was not yet transformed into a knob
        jQuery('#time-wrapper').prepend('<input type="text" name="{name}" id="knob-minutes" value="{value}">');
...
CSS
    ...
    {
        //$this->fileCss('');
        $this->fileJs('https://cdn.jsdelivr.net/npm/jquery-knob@1.2.11/dist/jquery.knob.min.js');
    }
    ...
    public function codes()
    {
        ...
        $this->js = strtr($this->_layout["js"], [
            ...
            '{name}' => $this->name,
            '{fgcolor}' => $this->_config['fgcolor'],
            '{fgcolor2}' => $this->_config['fgcolor2'],
