 ...
 */
class ZElfinderWidget2 extends ZWidget
{
    ...
    public $handler = [
        'html'  => "/render/<file>",
        'php' => "/core/tester/asror/main.aspx?path=render/<file>",
        'video' => "<file>",
        'jpeg'=> "main.aspx?path=uploads/<file>"
    ];
    public const type = [
            ...
            $('#{id}').elfinder(
                // 1st Arg - options
                {
                   ...
                   function str_replace() {
                            ...
                            var extFile = fileNameFull.substr(fileNameFull.lastIndexOf('.') + 1);
                            var extFile = mainString =  {handler}[extFile];
                            var fullUrl =  mainString.replace("<file>", fileNameFull);
                            return fullUrl;
                        }   
                       
                         var fileNameFull = atob(encPath);
                            var extFile = fileNameFull.substr(fileNameFull.lastIndexOf('.') + 1); 
                             const iterator = {handler}.keys();
...
JS,
    ...
    public function codes()
    {
        ...
        $this->js = strtr($this->_layout['js'], [
            ...
            '{handler}' => $this->jscode($this->handler)
