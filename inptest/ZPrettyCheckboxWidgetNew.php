 ...
 *
 */
class ZPrettyCheckboxWidgetNew extends ZWidget
{
    /**
     * Configuration
     */
    public $config = [];
    public $_config = [
        'type' => ZPrettyCheckboxWidgetNew::type['default'],
        'plain' => ZPrettyCheckboxWidgetNew::border['curve'],
        'style' => ZPrettyCheckboxWidgetNew::style['fill'],
        'color' => ZPrettyCheckboxWidgetNew::color['info'],
        'color2' => ZPrettyCheckboxWidgetNew::color['primary'],
        'border' => ZPrettyCheckboxWidgetNew::border['plain'],
        'animation' => ZPrettyCheckboxWidgetNew::animation['pulse'],
        'switchType' => ZPrettyCheckboxWidgetNew::switchType['outline'],
        'text' => 'Label',
    ...
    public function asset()
    {
        ...
        $this->fileCss('https://cdn.jsdelivr.net/npm/pretty-checkbox@3.0.3/dist/pretty-checkbox.min.css');
    }
...
HTML,
    ...
    <div class="pretty p-default {plain} mb-2 {style} {border} {animation}" style="display: block">
        <input type="checkbox" name="{modelClass}[{attribute}][{key}]" id="{id}" {checked1} >
...
CSS,
    ...
    public function codes()
    {
        ...
        foreach ($this->data as $key => $data) {
            if ($this->value > 0) {
                foreach ($this->value as $key1 => $items) {
                    if ($key === $key1) {
                        $check = 'checked';
                    } else {
                        $check = '';
