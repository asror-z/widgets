 ...
 *
 * clean
 * testing/Inptest/ZMultiselectWidget/tegmang.html
 *
 * Created By: Dilmurod Axmadov
 * Refactored: ZMediaCardWidget
 */
class ZMultiselectWidgetRef extends ZWidget
{
    ...
    public $config = [];
    public $_config = [
        'isMultiple' => ZMultiselectWidgetRef::type['multiple'],
        'csvDispCount' => 3,
        'placeholder' => '',
