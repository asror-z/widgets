 ...
 *
 *
 * Created By: G'ulomqodirov Shahzod
 */
class ZMenuWidget extends ZWidget
{
    ...
    public $_layout = [
        'main' => <<<HTML
            ...
            <section class="{slider-area}" style="max-width: {max-width};">
                    <div class="row">
                        <div class="col-md-12 col-lg-12 {class_position}">
                            <div class="{menu-widget}">
                                <p class="bg-white p-2 pl-3 text-success"><i class="fas fa-bars"></i><a class="bg-white pl-0 py-2 pr-0 text-success"  href="/shop/user/category-index/main.aspx">{name}</a></p>
...
HTML,
        'main_li' => <<<HTML
            ...
            <li class="menu-item items-menu py-1 border-0 itemmm">
             
                <div class="p-1 pl-2 text-center d-inline text-muted" style="width: 60px!important;">
                <i class="fal fa-{icon}" style="width: 20px"></i>
                </div>
                <a target="{target}" class="text-dark d-inline text-decoration-none border-0 zLoader" href="{url}">
                    {label} 
                </a>
...
HTML,
        'block' => <<<HTML
            <div class="smartphone">
                <a href="{url}" style="max-width: 50vh;">
...
HTML,
        'leaf' => <<<HTML
            <a class="fp-16" style="line-height: initial; max-width: 50vh;" target="{target}" href="{url}">{label}</a>
HTML,
        'left_partners' => <<<HTML
