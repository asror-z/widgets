...
class ZMarketCardsWidgetX extends Zwidget
{
    public $config = [];
    public $_config = [
               ...
               <div class="row">
                   ...
                   <div class="col-lg-8 col-md-12">
                       ...
                       <div class="item-content">
                        ...
                        <button class="btn btn-outline-success text-dark card-lb-btn"><i class="fas fa-cart-arrow-down mr-2"></i>Add to card</button>
</span>
                 ...
                 <div class="col-md-12 card-lb tab-img">
                    ...
                    <div class="card-lb-content">
                        ...
                        <div class="d-flex card-lb-content--items">
                            ...
                            <p class="card-price-env {isEmptyCurrency}">{currency}{price_old}</p>
                        </div>
                    </div>
...
JS,
    ...
    var main_parent = $('.card-lb');

    let templ = "<div class='card-lb-counter d-flex'>" +
        "<button  type='button' disabled class='btn btn-success btn-sm minCounter' style='opacity: 0.2; cursor: no-drop'" +
         "'>-</button>"+ "<div style='width: 50%;padding:10px; border: 1px solid lightgray' " +
          "class='counters'>1</div>" +"<button class='btn btn-sm btn-success addCounter' type='button' '" +
           " '>+</button>"+
        "</div>";

    let shopIcon = "<i id='iconShop' class=\"fas fa-shopping-cart ml-auto\"></i>";

    let badge = "<div class='badge-counter' style='width: 50px;padding:10px; text-align: center; height: 50px;background-color:green; color: white; border-radius: 50%;position: absolute; top: 2%;right: 5%'>1</div>";
 ...
 /*   let cardLengt = $('.card-lb').length;
    ...
    let addCard =  $("button:contains('Add To Cart')");*/
    ...
    butt.on('click', function () {
        ...
        let url2 = "/render/market/LeBazar Card/counter2.js";
        $.ajax({
            url: url,
            method:'GET',
    ...
    /***** Shopping Cart *****/
    $('.cart-btn,button:contains("Add To Cart")').on('click', function (event){
        e.preventDefault();
        ...
        if ($this->model !== null)
            $addCart = ZButtonWidget::widget([
                'config' => [
                    ...
                    //'data' => '{product_id:' . $this->model->id . '}'  // xato bervotti tuzatib keyin ulela!!!!
                ],
                'event' => [
