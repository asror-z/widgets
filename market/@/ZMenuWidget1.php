 ...
 */
class ZMenuWidget1 extends ZWidget
{
                    ...
                    <div class="row">
                        <div class="col-md-12 col-lg-12 {class_position}">
                            <div class="{menu-widget}">
                                <p class="bg-white border p-2 text-success"><i class="fas fa-bars"></i>{name}</p>
...
HTML,
        'main_li' => <<<HTML
            ...
            <div class="p-1 text-center d-inline text-muted" style="width: 50px">
            <i class="fas fa-{icon}">
...
HTML,
        'leaf' => <<<HTML
            <a style="line-height: 14px!important" target="{target}" href="{url}">{label}</a>
HTML,
        'left_partners' => <<<HTML
