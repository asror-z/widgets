 ...
 */
class ZMenuWidgetSalohiddin extends ZWidget
{
                    ...
                    <div class="row">
                        <div class="col-md-12 col-lg-12 {class_position}">
                            <div class="{menu-widget}">
                                <p class="bg-white border p-1 text-success justify-content-between d-flex"><a class="bg-white p-2 text-success"  href="/shop/user/category-index/main.aspx"><i class="fas fa-bars"></i>{name}</a>
                                 <a class="bg-white p-2 text-success clear_menu"  href="#">X</a></p>
