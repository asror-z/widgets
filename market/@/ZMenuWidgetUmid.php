 ...
 */
class ZMenuWidgetUmid extends ZWidget
{
    ...
    public function asset()
    {
        ...
        $this->fileCss('/render/market/ZMenuWidget/asset/css/styleUMID.css');
    }
                    ...
                    <div class="row">
                        <div class="col-md-12 col-lg-12 {class_position}">
                            <div class="{menu-widget}">
                                <p class="bg-white border p-2 text-success"><i class="fa fa-bars"></i>{name}</p>
...
HTML,
        'main_li' => <<<HTML
            ...
            <li class="menu-item items-menu border-0 d-flex">
             
            <div class="p-1 text-center text-muted" style="width: 50px"><i class="fas fa-{icon}"></i></div>
