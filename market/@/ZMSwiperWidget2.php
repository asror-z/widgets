...
class ZMSwiperWidget2 extends ZWidget
{
    public $config = [];
    public $_config = [
        'slideWidget' => false,
        ...
        'keyboard' => true,
        'loop' => true,
        'effect' => ZMSwiperWidget2::effect['fade'],
        'grabCursor' => true,
        'rotate' => 50,
        'stretch' => 0,
        'depth' => 100,
   ...
   <div class="swiper-container" id="{id}">
    ...
    <!-- Add Navigation -->
    <div class="swiper-button-prev {d-none} rounded-circle bg-success p-4 text-white position-absolute"></div>
    <div class="swiper-button-next {d-none} rounded-circle bg-success p-4 text-white position-absolute"></div>
</div>
