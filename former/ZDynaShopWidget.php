 ...
 *
 */
class ZDynaShopWidget extends ZDynaWidget
{
    ...
    public $_config = [
        ...
        'expandUrl' => '{fullUrl}/expand.aspx?modelClassName={modelClassName}',
        'approvedUrl' => '{fullUrl}/create.aspx?id={id}&model={modelClassName}',
    ...
    public $_rightBtn = [
        ...
        'export' => [
            'content' => '{jsonExcel}{exportAll}',
            //    'content' => '{jsonExcel}{export}{exportAll}',
    ...
    public function init()
    {
        ...
        $this->_config['title'] = strtr($this->_config['title'], [
    ...
    public function codes()
    {
        ...
        $this->sessionSet('returnUrl', $this->urlMain);
            ...
            'action' => function () {
                ...
                return [
                    ...
                    'value' => function ($model, $keys, $index, DataColumn $dataColumn) {
                        ...
                        //vdd(ZArrayHelper::getValue($this->_config['spaArray'], 'update'));

                        $buttons = [
                            'view' => strtr($this->_layout['actionModal'], [
                                '{title}' => Az::l('Просмотр'),
                                '{class}' => 'dynagrid-action-buttons d-inline',
                            ...
                            'update' => strtr($this->_layout['actionModal'], [
                                '{title}' => Az::l('Изменить'),
                                '{class}' => 'dynagrid-update-buttons d-inline',
                            ...
                            'clone' => strtr($this->_layout['actionConfirm'], [
                                ...
                                '{class}' => 'dyna-confirm-button d-inline',
                                '{data-url}' => $cloneUrl,
                                '{data-type}' => 'clone',
                ...
                return [
                    ...
                    'value' => function ($model, $key, $index, DataColumn $dataColumn) {
                        ...
                        return ZIframeSpaWidget::widget([
                            ...
                            'model' => $model,
                            'config' => [
                                'url' => '/crud/shop-order-item/index.aspx',
                                'key' => $key,
                                'width' => '100%',
                          ...
                          */
                            ...
                            return ZIframePanelWidget::widget([
                                ...
                                'config' => [
                                    ...
                                    'key' => $key,
                                    'funcName' => 'bosya1',
                                    'size' => ZIframeSpaWidget::sizeIframe['sm'],
                                    'type' => ZIframeSpaWidget::type['other'],
...
JS,
   ...
   $('.dyna-editable').on('click', function () {
      /* start:TursunaliyevAbdulloh */ 
       ...
       var h1 = `<h1 class="jsPanel-title">{title}`+ options.title + `</h1>`;

       /*//$('.swal2-content').loader('show')*/
       $('.jsPanel-titlebar').html(h1)
   
       var iframe = $('#jsPanel-edit-dyna-iframe')
       var url = options.url;
...
JS,
        ...
        if ($this->type === self::type['model'] || $this->type === self::type['array'])
...
JS
                ...
                'id' => 'jamster-' . $this->modelClassName,
                'config' => [
                    'icon' => 'fas fa-plus',
                    'title' => 'BOS',
                    'btnRounded' => false,
    ...
    function() {       
            console.log('Jamster');
              ...
              var button = document.getElementById('reload-{$this->modelClassName}');
...
JS,
        ...
        $theme = str_replace('panel-', 'btn btn-', $this->_config['theme']);

        if ($this->_config['theme'] === 'default') {
            $theme = str_replace('default', '', $this->_config['theme']);
        }
        ...
        $approvedUrl = strtr($this->_config['approvedUrl'], [
            '{modelClassName}' => $this->modelClassName,
            '{fullUrl}' => $this->prelastUrl(),
        ]);
        ...
        $approved = '';
        if ($this->model->configs->showSystemColumn && $this->type === 'model' && $this->_config['approved']) {
            $approved = ZButtonWidget::widget([
                'model' => $this->model,
        ...
        if ($this->type === 'model' && $this->model->configs->showStats)
        ...
        $exportExcel = $this->_layout['exportExcel'];
...
HTML;
        ...
        <!--<iframe id="ravshanDyna" name="editable-iframe" src="/core/edit/editableOff.aspx"
...
JS,
    ...
    private function modelColumnGen()
    {
        ...
        if (!ZArrayHelper::keyExists('sort', $this->model->columns) || !$this->_config['hasSort']) {
    ...
    private function resetUrl()
    {
        ...
        if (empty($this->_config['resetUrl']))
            $resetUrl = "{$this->urlArrayStr}.aspx";
        return $resetUrl;
