...
class ZEditableIframeWidget extends ZWidget
{
    ...
    public $_config = [
        ...
        'height' => '600px',
        'key' => '',
        'type' => ZEditableIframeWidget::type['sweet'],
        'isSession' => false,
        'options' => [],
        'data' => [],
        'formId' => '',
...
JS,
    ...
    $("#editable-{id}").on('click',  function () {
       ...
       /* 
        ...
        $('#editable-url-{modelName}').val('{urlGet}')
...
CSS,
    ...
    public function codes()
    {
        ...
        $this->js = strtr($this->_layout['js'], [
            ...
            '{modelId}' => $this->jscode($this->_config['key']),
            ...
            '{urlGet}' => $this->jscode($this->urlMain),
