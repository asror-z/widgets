...
class ZMyCardWidgetDataTable extends ZWidget
{
    /**
     * Configuration
     */
        ...
        <tr class="d-print-table-row border-bottom product_item" >
            ...
            <td class="align-middle ">
                <div class="d-md-flex d-sm-block d-block flex-md-column flex-lg-row">
                   ...
                   <div class="img-fluid basket-image d-md-flex d-sm-block d-block" style="background-image: url('{image}'); background-size: contain; background-position: center center;"></div>
            ...
            <td class="align-middle text-center px-0">
                    ...
                    <span class="mr-1">{currency_left}</span>
            ...
            <td class="align-middle text-center px-0">
                ...
                <span class="mr-1">{currency_left}</span>
                    <div class="font-weight-medium">
                     <span id="total{id}" class="totals price-format ztotal">{total}</span>
                     {currency_right}
                    </div>
                </div>
            </td>
        ...
        $(".delete_product_in_cart").on("click", function(){
            ...
            $.ajax({
                ...
                success: function(data){
                    $.pjax.reload({container: '#dataTableReload', async: true});
...
JS,
    ...
    public function asset()
    {
        ...
        $this->fileJs('/render/cards/ZMyCardWidget/asset/js/inputchange.js');
