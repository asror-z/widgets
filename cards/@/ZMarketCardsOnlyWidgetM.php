...
class ZMarketCardsOnlyWidgetM extends ZWidget
...
HTML,
        ...
        'col'=> <<<HTML
            ...
            <!-- Card Regular -->
                <div class="card h-100 card-cascade rounded-lg position-relative">
        ...
        <div class="m-1 text-center height="100px">
            ...
            <span style="right: 15px" class="counter position-absolute fz-26 mt-5">{sale}%</span>
        ...
        <div class="card-body card-body-cascade text-center p-3">
            ...
            <h4 class=" d-flex">
                <div class="col-7 text-left p-0 mw-100">
                    <strong class="fz-22">{title}</strong>
                </div>
                <div class="col-5 text-right p-0">
                    <a class="text-muted iconhover fz-22 pr-3" onclick="add_wish_list({product_id})"><i class="fa fa-heart"></i></a>
                    <a class="text-muted iconhover fz-22" onclick="add_compare_list({product_id})"><i class="fa fa-chart-bar"></i></a>
                </div>
            </h4>
<!--
            ...
            <h6 class="font-weight-bold text-left indigo-text py-3 fz-20">{isHave}</h6>-->
             ...
             <div class="d-flex justify-content-between">
                <span class="text-left text-left text-success py-2 fz-20">{isHave}</span>
                <span class="font-weight-bold text-left text-black-50 py-2 fz-14"></span>
            </div>
             ...
             <div class="d-flex justify-content-between mr-0">
                    ...
                    <span class="small fz-16">(2 отзыва)</span>
</div>
                </div>
            <!-- Subtitle -->
            ...
            <div class="d-flex justify-content-between">
                <div class="">
                    <h6 class="font-weight-bold text-left indigo-text py-2 fz-20 text-danger">{price} {currency}/ шт.</h6>
                    <!-- Text -->
                    <p class="card-text fz-14 text-left"><strike>{price_old}</strike>
