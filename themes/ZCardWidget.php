 ...
 *
 */
class ZCardWidget extends ZWidget
{
...
HTML,
        'header' => <<<HTML
             <div class=" card-header {headerColor} text-white p-1 pl-3">
              {title}
            </div>
HTML,
        'image' => <<<HTML
...
HTML,
        ...
        'dynCard' => <<<HTML
        <div class="card {shadow} {classBorderColor} {classBgColor} {dynClass}">
            {dynaCardHeader}
...
HTML,
        ...
        'dynaCardHeader' => <<<HTML
            <div class="view overlay">   
                <div class="card-header {classHeadColor} {text-align} py-2 pl-4 pl-lg-3 pr-2">
...
CSS,
    ...
    public function codes()
    {
        ...
        $this->htm .= strtr($this->_layout[$this->_config['type']], [
            ...
            '{dynClass}' => $this->_config['dynClass'],
            '{content}' => $content,
            '{id}' => $this->id,
            '{title}' => $this->_config['title'],
