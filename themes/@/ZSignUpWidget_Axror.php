...
class ZSignUpWidget_Axror extends ZWidget
{
    public $layout = [];
    public $_layout = [
        'main' => <<<HTML
...
HTML,
        ...
        'userStatus' => <<<HTML
            ...
            <div class="mt-2">
                <a href="/core/user/user-profile/profile-settings.aspx" class="p-0 mb-3 d-flex justify-content-between align-items-center"><span class="xdropdownSubtitle fp-16">Мой профиль</span>
                   <i class="fas fa-user-circle fp-15"></i>
                </a>
                <a href="/client/order/main.aspx" class="p-0 mb-3 d-flex justify-content-between align-items-center"><span class="dropdownSubtitle fp-16">Активные заказы</span>
                <i class="fas fa-check-circle fp-15"></i>
                </a>
                <a href="/client/order/history.aspx" class="p-0 mb-3 d-flex justify-content-between align-items-center"><span class="fp-16 dropdownSubtitle">История заказов</span>
                <i class="fas fa-archive fp-15"></i>
                </a>
                <a href="/client/change-password/main.aspx" class="p-0 d-flex justify-content-between align-items-center mb-3"><span class="dropdownSubtitle">Изменит пароль</span>
                <i class="fas fa-key fp-15"></i>
                </a>
            </div>
            <div class="userStatus">
          <a href="/core/user/user-auth/logout.aspx" class="d-flex justify-content-between align-items-center m-0 p-1 rounded">
                <div class="ml-0 menu-text text-danger">Выход</div>
                    <i class="fas fa-sign-out-alt ml-3 mt-1 text-danger"></i>
            </a>
        </div>
HTML,
