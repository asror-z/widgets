...
class ZNotifyNew2Widget extends ZWidget
{
...
HTML,
            'pro' => <<<HTML
                      <div class="child-menu">
                            <div class="content-list content-image">
                                    <div id="{id}" class="mCustomScrollbar _mCS_2" style="overflow:hidden;">
                                        <ul class="list-wrapper pd-lr-10">{content}  
                                        </ul>
                                    </div>
                                      <div class="closing text-center" style="">
...
JS
            ...
            if ($messageItem->read)
                ...
                $content .= strtr($this->layout['unread'][$this->_config['type']], [
                    '{userPhoto}' => $messageItem->photo,
                    '{text}' => $messageItem->text,
                    '{name}' => $messageItem->name,
                    '{time}' => $messageItem->time,
