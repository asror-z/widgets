...
class  ZFooterChatWidget extends ZWidget
{
    ...
    public $config = [];
    public $_config = [
        'type' => ZFooterChatWidget::type['main'],
    ];
    ...
    public $_event = [
          ...
          public $_layout = [
              ...
              'main' => <<<HTML
    <body id="pages"
      class="full-layout  nav-right-hide nav-right-start-hide  nav-top-fixed      responsive    clearfix breakpoint-975"
        ...
        <div class="vd_mega-menu-wrapper">
            ...
            <span class="mega-icon">
                ...
                8
                        ...
                        <div class="vd_mega-menu-content width-xs-3 width-sm-4 width-md-4 center-xs-4 open-top" data-action="click-target" style="display: block;">
                            <div class="child-menu">
                                <div class="title">
                     ...
                     <span data-original-title="Task Setting" data-toggle="tooltip" data-placement="bottom" class="menu">
                        <i class="fa fa-cog"></i>
                                ...
                                <div class="content-list content-image">
                                    <div data-rel="scroll" class="mCustomScrollbar _mCS_10" style="overflow: hidden;"><div class="mCustomScrollBox mCS-light" id="mCSB_10" style="position: relative; height: 100%; overflow: hidden; max-width: 100%; max-height: 400px;"><div class="mCSB_container" style="position: relative; top: 0px;">
                                                <ul class="list-wrapper pd-lr-10">
                                                    ...
                                                    <li> <a>
                                                            <div class="menu-icon"><img alt="example image" src="/publish/inputs/user-inputs/demo_files/avatar-3.jpg"></div>
                                ...
                                <div class="content-list  content-image">
                                    <div data-rel="scroll" class="mCustomScrollbar _mCS_13" style="overflow: hidden;"><div class="mCustomScrollBox mCS-light" id="mCSB_13" style="position: relative; height: 100%; overflow: hidden; max-width: 100%; max-height: 400px;"><div class="mCSB_container mCS_no_scrollbar" style="position: relative; top: 0px;">
                                                <ul class="list-wrapper pd-lr-10">
                                                    ...
                                                    <li>
                                                        <a href="http://www.venmond.com/asset/vendroid/index-ecommerce.php#">
                                                            <div class="menu-icon"><img src="/publish/inputs/user-inputs/demo_files/avatar-3.jpg" alt="example image"></div>
                                                    ...
                                                    <li>
                                                        <a href="http://www.venmond.com/asset/vendroid/index-ecommerce.php#">
                                                            <div class="menu-icon"><img src="/publish/inputs/user-inputs/demo_files/avatar-4.jpg" alt="example image"></div>
                                                    ...
                                                    <li>
                                                        <a href="http://www.venmond.com/asset/vendroid/index-ecommerce.php#">
                                                            <div class="menu-icon"><img src="/publish/inputs/user-inputs/demo_files/avatar-5.jpg" alt="example image"></div>
                                                    ...
                                                    <li>
                                                        <a href="http://www.venmond.com/asset/vendroid/index-ecommerce.php#">
                                                            <div class="menu-icon"><img src="/publish/inputs/user-inputs/demo_files/avatar-6.jpg" alt="example image"></div>
                                                    ...
                                                    <li>
                                                        <a href="http://www.venmond.com/asset/vendroid/index-ecommerce.php#">
                                                            <div class="menu-icon"><img src="/publish/inputs/user-inputs/demo_files/avatar-7.jpg" alt="example image"></div>
                                                    ...
                                                    <li>
                                                        <a href="http://www.venmond.com/asset/vendroid/index-ecommerce.php#">
                                                            <div class="menu-icon"><img src="/publish/inputs/user-inputs/demo_files/avatar-8.jpg" alt="example image"></div>
