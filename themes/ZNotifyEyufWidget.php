...
class ZNotifyEyufWidget extends ZWidget
{
...
HTML,
        ...
        'unread' => [
            'mdb' => <<<HTML
         <li class="notify-li" id="{id}" data-url="{link}">
               
                <div class="menu-icon ">
                    <img class="img-1" alt="photo" src="{userPhoto}">
                </div>
          ...
          /*  echo ZSweetAlert2Widget::widget([
            ...
            $eyeBtn = ZButtonWidget::widget([
                'config' => [
                    ...
                    'class' => 'h-100 p-0',
                    'iconColor' => '#0d47a1',
                    'icon' => 'fa fa-' . $messageItem->read ? FA::_EYE_SLASH : FA::_EYE,
                ],
                'event' => [
                    'click' => <<<JS
                        function() {
                            $.ajax({
                            url: '/api/core/chat-eye-remove.aspx',
                            method: "GET",
                            data: {
                                id: '$messageItem->id',
                            },
...
JS;
        ...
        $viewButton = ZButtonWidget::widget([
            ...
            'event' => [
                'click' => <<<JS
                    function () {
                     viewAll('/api/eyuf/read.aspx?id=$id');
                    }
