 ...
 */
class ZPeriodPickerCallWidget extends ZWidget implements ZPeriodPickerWidgetConst
{
    ...
    public function asset()
    {
        ...
        $this->fileJs('/render/inputes/ZPeriodPickerWidget/assets/PeriodPicker/jquery.periodpicker.full.min.js', View::POS_END);
