 ...
 */
class ZPeriodPickerWidgetX extends ZWidget implements ZPeriodPickerWidgetConst
{
    public $config = [];
    public $_config = [
    ...
    public function codes()
    {
        ...
        <input id="periodpickerend" class="{class}" style="{style}" name="{modelClassName}[{attribute}][]" type="text" value="<?= $st2 ?> ">
