 ...
 */
class ZTinyCloudWidgetMIRSHOD extends ZWidget
{
    /**
     * Configuration
     */
...
CSS,
    ...
    public function codes()
    {
        ...
        $this->js = strtr($this->_layout['jsCode'], [
            '{id}' => $this->id,
            '{Heading 1}' => Az::l('Заголовок 1'),
            '{Heading 2}' => Az::l('Заголовок 2'),
            '{Heading 3}' => Az::l('Заголовок 3'),
            '{Heading 4}' => Az::l('Заголовок 4'),
            '{Heading 5}' => Az::l('Заголовок 5'),
            '{Heading 6}' => Az::l('Заголовок 6'),
            '{Bold}' => Az::l('Смелый'),
            '{Italic}' => Az::l('курсивный'),
            '{Underline}' => Az::l('Подчеркнутый'),
            '{Strikethrough}' => Az::l('Зачеркнутый'),
            '{Superscript}' => Az::l('верхний индекс'),
            '{Subscript}' => Az::l('индекс'),
            '{Code}' => Az::l('Код'),
            '{Paragraph}' => Az::l('Пункт'),
            '{Blockquote}' => Az::l('Blockquote'),
            '{Div}' => Az::l('Div'),
            '{Pre}' => Az::l('до'),
            '{Left}' => Az::l('налево'),
            '{Center}' => Az::l('Центр'),
            '{Right}' => Az::l('направо'),
            '{Justify}' => Az::l('выровнить'),
        ]);
