...
class ZPeriodPickerWidget extends ZWidget implements ZPeriodPickerWidgetConst
{
    ...
    public function codes()
    {
        ...
        <!-- Version 1-->            
        <input id="periodpickerstart" name="{modelClassName}[{attributeStart}]" placeholder="{placeholder}"  type="text" value="<?= $st1 ?> ">
        <input id="periodpickerend" class="{class}" name="{modelClassName}[{attributeEnd}]" type="text" value="<?= $st2 ?> ">
        ...
        <input name="{modelClassName}[{attribute}]" type="hidden" value="start{$delimiter}end">
