...
class ZMmenuWidget_S extends ZWidget
{
    public $config = [];
    public $_config = [
        'type' => ZMmenuWidget_S::type['Menu'],
        'nameOn' => [],
        'isName' => true,
        'isAll' => true,
        'isApp' => true,
        'menu_ids' => [],
        'theme' => ZMmenuWidget_S::theme['eyuf'],
        'pagedim' => ZMmenuWidget_S::pagedim['pagedim-black'],
        'dividers.add' => false,
        ...
        'all.border' => ZMmenuWidget_S::border['border-none'],
        'position' => ZMmenuWidget_S::position['position-back'],
        'shadows' => ZMmenuWidget_S::shadows['shadow-page'],
        'fx-slides' => ZMmenuWidget_S::fx_slide['fx-panels-slide-0'],
