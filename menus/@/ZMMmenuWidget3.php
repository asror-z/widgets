...
class ZMMmenuWidget3 extends ZWidget
{
    public $config = [];
    public $_config = [
        'name' => '',
        ...
        'isApp' => true,
        'menu_ids' => [],
        'theme' => ZMMmenuWidget3::theme['eyuf'],
        'pagedim' => ZMMmenuWidget3::pagedim['pagedim-white'],
        'dividers.add' => true,
        ...
        'all.border' => ZMMmenuWidget3::border['border-none'],
        'position' => ZMMmenuWidget3::position['position-back'],
        'shadows' => ZMMmenuWidget3::shadows['shadow-menu'],
        'fx-slides' => ZMMmenuWidget3::fx_slide['fx-panels-slide-0'],
    ...
    public $_layout = [
        ...
        'main' => <<<HTML
 <nav id="menu"  class="mm-panel mm-panel_opened"  '>
...
HTML,
        ...
        <li class="mm-listitem">
            <a href='{url}' class="mm-listitem__text mm-listitem__btn"></i>{home}</a>
        </li>
HTML,

        'linkTemplate' => <<<HTML
                <a href="{url}" data-item="{data-item}" class="mmenu-item mm-listitem__text mm-listitem__btn">{icon}&nbsp;&nbsp; {label}</a>
HTML,

        'linkTemplateBlank' => <<<HTML
                  <a href="{url}" class="mm-listitem__text mm-listitem__btn" target="_blank">{icon}&nbsp;&nbsp; {label}</a>
HTML,

        'linkTemplateItem' => <<<HTML
                  <a {data-id} class="mmenu-item mm-listitem__text mm-listitem__btn" data-item="{data-item}" href="{url}">{icon}&nbsp;&nbsp; {label} </a>
HTML,

        'subMenuTemplate' => <<<HTML
       <ul class="treeview-menu mm-listview">{items}</ul> 
HTML,
...
CSS,
    ...
    public function asset()
    {
        ...
        /*$this->fileJs('/render/menus/ZMMmenuWidget/assets/mmenu/layout.js');*/
    ...
    public function codes()
    {
        ...
        if (empty($this->_config['content']))
            $this->_config['content'] = "<div class=\"zlogo\"><img src=\"/imagez/eyuf/logo1.jpg\" width=\"{$this->_config['content.img.width']}\"></div>";
