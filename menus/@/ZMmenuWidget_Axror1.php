...
class ZMmenuWidget_Axror1 extends ZWidget
{
    public $config = [];
    public $_config = [
        'type' => ZMmenuWidget_Axror1::type['Menu'],
        'nameOn' => [],
        'isName' => true,
        'isAll' => true,
        'isApp' => true,
        'menu_ids' => [],
        'theme' => ZMmenuWidget_Axror1::theme['eyuf'],
        'pagedim' => ZMmenuWidget_Axror1::pagedim['pagedim-black'],
        'dividers.add' => false,
