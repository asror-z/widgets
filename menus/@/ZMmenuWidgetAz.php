...
class ZMmenuWidgetAz extends ZWidget
{
    public $config = [];
    public $_config = [
        'type' => ZMmenuWidget::type['Menu'],
        'nameOn' => [],
        'isName' => true,
        'isAll' => true,
        'isApp' => true,
        'menu_ids' => [],
        'theme' => ZMmenuWidget::theme['white'],
...
HTML,
        ...
        'homeItem' => <<<HTML
        <li>       
            <a href='{url}' target="_blank"><i class="fal fa-home"></i>{home}</a>
        </li>
HTML,

        'linkTemplate' => <<<HTML
                <a href="{url}" data-item="{data-item}" target="_blank" class="mmenu-item {class}">{icon}&nbsp;&nbsp; {label}</a>
HTML,
...
HTML,
        ...
        'linkTemplateItem' => <<<HTML
                  <a {data-id} class="mmenu-item {class}" target="_blank" data-item="{data-item}" href="{url}">{icon}&nbsp;&nbsp; {label} </a>
HTML,
...
CSS,
    ...
    public function asset()
    {
        ...
        $this->fileCss('/render/asrorz/css/mmenu.css');
...
JS;
        ...
        if ($this->_config['isAll']) {
            $content .= '<hr class="border border-secondary">';
