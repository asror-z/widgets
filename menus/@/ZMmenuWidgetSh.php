...
class ZMmenuWidgetSh extends ZWidget
{
    public $config = [];
    public $_config = [
        'nameOn' => '',
...
CSS,
    ...
    public function codes()
    {
        ...
        $logo = ZSVGWidget::widget();
        //

        if (empty($this->_config['content']))
            $this->_config['content'] = "<div><img src=\"/render/menus/ZMMmenuWidget/img/logo.svg\"></div>";
