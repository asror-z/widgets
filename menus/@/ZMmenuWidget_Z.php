...
class ZMmenuWidget_Z extends ZWidget
{
    public $config = [];
    public $_config = [
        'type' => ZMmenuWidget_Z::type['Menu'],
        'nameOn' => [],
        'isName' => true,
        'isAll' => true,
        'isApp' => true,
        'menu_ids' => [],
        'theme' => ZMmenuWidget_Z::theme['eyuf'],
        'pagedim' => ZMmenuWidget_Z::pagedim['pagedim-black'],
        'dividers.add' => false,
        ...
        'all.border' => ZMmenuWidget_Z::border['border-none'],
        'position' => ZMmenuWidget_Z::position['position-back'],
        'shadows' => ZMmenuWidget_Z::shadows['shadow-page'],
        'fx-slides' => ZMmenuWidget_Z::fx_slide['fx-panels-slide-0'],
