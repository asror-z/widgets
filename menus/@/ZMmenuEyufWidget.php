...
HTML,
        ...
        'homeItem' => <<<HTML
        <li>       
            <a href='{url}?{args}' target="_blank"><i class="fal fa-home"></i>{home}</a>
        </li>
HTML,
...
CSS,
    ...
    public function asset()
    {
        ...
        $this->fileCss('/render/menus/ZMMmenuWidget/theme/theme_eyuf.css');
            ...
            var options = {
                ...
                */
                navbars: [
                    {
                        content: [
                            '<div class="zlogo"><img src="/render/asrorz/images/logo.jpg" width="150px"></div>'
                        ],
                        position: "{p-top}"
                    },
                    {
