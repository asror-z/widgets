...
class ZMmenuWidget_Sobitjon extends ZWidget
{
    public $config = [];
    public $_config = [
        ...
        'isApp' => true,
        'menu_ids' => [],
        'theme' => ZMmenuWidget_Sobitjon::theme['eyuf'],
        'pagedim' => ZMmenuWidget_Sobitjon::pagedim['pagedim-black'],
        'dividers.add' => false,
        ...
        'all.border' => ZMmenuWidget_Sobitjon::border['border-none'],
        'position' => ZMmenuWidget_Sobitjon::position['position-back'],
        'shadows' => ZMmenuWidget_Sobitjon::shadows['shadow-page'],
        'fx-slides' => ZMmenuWidget_Sobitjon::fx_slide['fx-panels-slide-0'],
