...
class ZMmenuWidget extends ZWidget
{
...
HTML,
        ...
        'linkTemplate' => <<<HTML
                <a href="{url}{args}" data-pjax="0" data-item="{data-item}" target="{target}" class="mmenu-item {class}">{icon}&nbsp;&nbsp; {label}</a>
HTML,


        'linkTemplateItem' => <<<HTML
                  <a {data-id} data-pjax="0" class="mmenu-item {class}" target="{target}" data-item="{data-item}" href="{url}{args}">{icon}&nbsp;&nbsp; {label} </a>
HTML,
        ...
        $(document).ready(function() {
            ...
            var options = {
                ...
                */
                ...
                onClick: {
                    close: false,
                    preventDefault: false, // true | false
                    setSelected: true,
                },
