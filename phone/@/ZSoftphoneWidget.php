 ...
 *
 * Created By: Jasurbek Normurodov

 */
class ZSoftphoneWidget extends ZWidget
{
...
//     */
    ...
    public function asset()
    {
        ...
        $this->fileCss('https://fonts.googleapis.com/css?family=Roboto:300,400,500,700&display=swap');
        $this->fileCss('https://cdnjs.cloudflare.com/ajax/libs/twitter-bootstrap/4.4.1/css/bootstrap.min.css');
        $this->fileCss('https://cdnjs.cloudflare.com/ajax/libs/mdbootstrap/4.16.0/css/mdb.min.css');
        $this->fileCss('../../../../render/siplibs/All/css/style1.css');




        $this->fileJs('https://cdnjs.cloudflare.com/ajax/libs/popper.js/1.14.4/umd/popper.min.js');
        $this->fileJs('https://cdnjs.cloudflare.com/ajax/libs/twitter-bootstrap/4.4.1/js/bootstrap.min.js');
        $this->fileJs('https://cdnjs.cloudflare.com/ajax/libs/mdbootstrap/4.16.0/js/mdb.min.js');
...
HTML,
    ...
    function createSipStack() {
        ...
        sipStack = new SIPml.Stack({
                ...
                impi: '300',
                impu: 'sip:300@94.158.52.244:7777',
                password: '300',
