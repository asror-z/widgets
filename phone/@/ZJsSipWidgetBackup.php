...
class ZJsSipWidgetBackup extends ZWidget
{
    ...
    <div class="main_block">
        <div class="block_item">
            <div class="right_block row">
                <div class="number text-center border col-md-12 ">
                    <div class="mb-2 mt-2 control_btn">
                        <rightBtn id="callButton" class="btn btnCall callButton btn1 py-2" title="Call">
                            <i class="fa fa-phone fa-2x text-success"></i>
                        </rightBtn>
                        <!--<rightBtn id="answerButton" class="btn btnCall answerButton btn1 py-2" title="Call">
                            <i class="fa fa-phone fa-2x text-dark"></i>
                        </rightBtn>-->
                        <rightBtn class="btn btnHangUp hangUpButton btn1 hangupBtn py-2" id="btnHangUp" title="Hangup">
            ...
            <div class="buuton-goup {itemKeypad} mb-lg-4 mb-3">
                <a type="rightBtn" class="btn-floating pt-3 fp-20 number-btn {buttonClass} mx-1 hvr-glow" value="1">1</a>
                <a type="rightBtn" class="btn-floating pt-3 fp-20 number-btn {buttonClass} mx-1 hvr-glow" value="2">2</a>
                <a type="rightBtn" class="btn-floating pt-3 fp-20 number-btn {buttonClass} mx-1 hvr-glow" value="3">3</a>
                <br>                                                       
                <a type="rightBtn" class="btn-floating pt-3 fp-20 number-btn {buttonClass} mx-1 hvr-glow" value="4">4</a>
                <a type="rightBtn" class="btn-floating pt-3 fp-20 number-btn {buttonClass} mx-1 hvr-glow" value="5">5</a>
                <a type="rightBtn" class="btn-floating pt-3 fp-20 number-btn {buttonClass} mx-1 hvr-glow" value="6">6</a>
                <br>                                                       
                <a type="rightBtn" class="btn-floating pt-3 fp-20 number-btn {buttonClass} mx-1 hvr-glow" value="7">7</a>
                <a type="rightBtn" class="btn-floating pt-3 fp-20 number-btn {buttonClass} mx-1 hvr-glow" value="8">8</a>
                <a type="rightBtn" class="btn-floating pt-3 fp-20 number-btn {buttonClass} mx-1 hvr-glow" value="9">9</a>
                <br>                                                       
                <a type="rightBtn" class="btn-floating pt-3 fp-20 number-btn {buttonClass} mx-1 hvr-glow" value="+">+</a>
                <a type="rightBtn" class="btn-floating pt-3 fp-20 number-btn {buttonClass} mx-1 hvr-glow" value="0">0</a>
                <a type="rightBtn" class="btn-floating backspace-btn mx-1 hvr-glow" value="c">
...
*/
        ...
        iframe.attr('src', '/agent/manual/update.aspx?id=' + session.remote_identity.uri.user);
        iframe.attr('height', '95%');
        iframe.attr('width', '100%');
...
JS,
        ...
        'css' => <<<CSS
         input::-webkit-outer-spin-rightBtn,
    input::-webkit-inner-spin-rightBtn {
