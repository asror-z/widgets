...
class ZSipmlWidgetX extends ZWidget
{
        ...
        <div class="main_block">
            ...
            <div class="block_item">
                <div class="video_panel d-none">
                    <div>
                        <div id="divCallCtrl" class="span7 well table align-middle">
                            ...
                            <div id='divCallOptions' class='call-options d-none opacity-0 mt-2'>
                ...
                <div class="right_block">
                    <div class="mt-3">
                        <div class="number {backgroundColor} text-center border w-10">
                            <div class="mb-2 mt-2 control_btn">
                                <button id="callBtn" class="btn btn-md btnCall btn1 py-2 {callBtn}" title="Call">
                                    <i class="fa fa-phone fa-2x text-success"></i>
                                </button>

                                <button id="videoBtn" class="btn btn-md btn1 py-2 {videoCallBtn}">
                                    <i class="fas success-ic fa-video fa-2x"></i>
                                </button>

                                <button class="btn btn-md btnHangUp btn1 hangupBtn py-2 {btnHangUp}" id="btnHangUp" title="Hangup">
                            ...
                            <div class="buyton-group mb-lg-4 mb-3 {keypad}">
...
JS,
    ...
    {
        foreach ($this->data as $SIPMLItem) {

            $this->htm = strtr($this->_layout['main'], [
            '{ringtone}' => $this->_config['ringtone'],
            '{ringbacktone}' => $this->_config['ringbacktone'],
            '{dtmfTone}' => $this->_config['dtmftone'],
            '{callBtn}' => $SIPMLItem->callBtn ? '' : "d-none",
            '{videoCallBtn}' => $SIPMLItem->videoCallBtn ? '' : "d-none",
            '{btnHangUp}' => $SIPMLItem->btnHangUp ? '' : "d-none",
            '{keypad}' => $SIPMLItem->keypad ? '' : "d-none",
