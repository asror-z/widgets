...
class ZSipmlWidgetIsmet extends ZWidget
{
                    ...
                    <div class="mt-3">
                        <div class="number {backgroundColor} text-center border w-10">
                            <div class="mb-2 mt-2 control_btn">
                                <button id="callBtn" class="btn btnCall btn1 py-2 {callBtn}" title="Call">
                                    <i class="fa fa-phone fa-2x text-success"></i>
                                </button>

                                <button id="videoBtn" class="btn btn1 py-2 {videoCallBtn}">
                                    <i class="fas success-ic fa-video fa-2x"></i>
                                </button>

                                <button class="btn btnHangUp btn1 hangupBtn py-2 {btnHangUp}" id="btnHangUp" title="Hangup">
                            ...
                            <div class="buuton-goup mb-lg-4 mb-3 {keypad}">
