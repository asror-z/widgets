...
class ZSipml5WidgetAbdulloh extends ZWidget
{
                ...
                <div class="right_block">
                    <div class="opacity mt-3">
                        <div class="number text-center border w-10">
                            ...
                            <div class=" buuton-goup mb-lg-4 mb-3 numbers">
...
JS,
    ...
    public function codes()
    {
        ...
        $mainJS = file_get_contents(Root . '/render/phone/ZSipml5Widget/fayzullo/js/mainAbdulloh.js');

        $this->js = strtr($mainJS, [
            '{realm}' => $this->_config['realm'],
            '{impi}' => $this->_config['impi'],
            '{number}' => $this->_config['number'],
            '{readonly}' => $this->jscode( $this->_config['readonly']),
            '{visibled}' => $this->jscode($this->_config['visibled']),
            '{keyboard}' => $this->_config['keyboard'],
            '{impu}' => $this->_config['impu'],
            '{password}' => $this->_config['password'],
            '{display_name}' => $this->_config['display_name'],
            '{websocket_proxy_url}' => $this->_config['websocket_proxy_url'],
            '{outbound_proxy_url}' => $this->_config['outbound_proxy_url'],
            '{ice_servers}' => $this->jscode($this->_config['ice_servers']),
            '{enable_rtcweb_breaker}' => $this->_config['enable_rtcweb_breaker'],
            '{enable_early_ims}' => $this->_config['enable_early_ims'],
            '{enable_media_stream_cache}' => $this->_config['enable_media_stream_cache'],
            '{bandwidth}' => $this->_config['bandwidth'],
            '{video_size}' => $this->_config['video_size']
        ]);;
