...
class ZJsSipWidgetXolmat extends ZWidget
{
...
*/
        ...
        iframe.attr('src', '/agent/manual/update.aspx?id=' + session.remote_identity.display_name);
        iframe.attr('height', '95%');
        iframe.attr('width', '100%');
        ...
        console.log('SUCCESS');
            ...
            if (session.direction == 'outgoing') {
                ...
                session.remote_identity.display_name;
                //idNumber.value = incomingPhoneNumber;
